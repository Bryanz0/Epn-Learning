...
<head>
    <meta charset="UTF-8">
    <title>Buscar Repositorio</title>
...
<div class="columna">
    <ul>
        <li><a id="submenuLocal" href="myRepositorio.php" >My Repositorio</a></li>
...
<div class="contenedor">
   ...
   ">
    ...
    <table class="tabla" style="margin-top:10px;">
        ...
        $sql="SELECT DISTINCT idRepositorio,titulo,descripcion,autor, directorio FROM repositorio WHERE titulo LIKE '%".$busqueda."%' OR descripcion LIKE '%".$busqueda."%' OR autor LIKE '%".$busqueda."%' OR palabrasClave LIKE '%".$busqueda."%'";
